...
struct Vertext {
    ...
    init(_ x: GLfloat, _ y: GLfloat, _ z: GLfloat, _ w: GLfloat, _ r: GLfloat, _ g: GLfloat, _ b: GLfloat, _ a: GLfloat, _ nX: GLfloat, _ nY: GLfloat, _ nZ: GLfloat, _ u: GLfloat, _ v: GLfloat) {
        self.x = x
        self.y = y
        self.z = z
        self.w = w
